                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form method="post" action="ubah_balita_bidan.php">
                                                    <div class="modal-body">
                                    ...
                                    <table class="table table-bordered table-striped text-center" width=100% display=block>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="ubah_balita_bidan.php?id_balita=<?= $data['id_balita'] ?>" type="button" class="btn btn-warning" data-toggle="modal"><i class="fas fa-pencil-alt"></i> Ubah</a>
...
<!-- PHP Script to handle the update -->
<?php
include 'koneksi.php';
if (isset($_POST['ubah'])) {
    $stmt = $koneksi->prepare("UPDATE balita SET NIK_balita = ?, nama_balita = ?, tempat_lahir_balita = ?, tgl_lahir_balita = ?, jenis_kelamin = ?, agama_balita = ?, NIK_ibu = ?, id_pengguna = ? WHERE id_balita = ?");
    $stmt->bind_param('sssssssss', $_POST['NIK_balita'], $_POST['nama_balita'], $_POST['tempat_lahir_balita'], $_POST['tgl_lahir_balita'], $_POST['jenis_kelamin'], $_POST['agama_balita'], $_POST['NIK_ibu'], $_POST['id_pengguna'], $_POST['id_balita']);
