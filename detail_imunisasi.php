                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <div class="card-box">
                                        <ul class="nav nav-pills navtab-bg nav-justified">
                                            ...
                                            <li class="nav-item">
                                                <a href="detail_pemeriksaan.php?id_balita=<?= $id_balita ?>" data-toggle="tab" aria-expanded="false" class="nav-link ">
                                                    Pemeriksaan
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="detail_imunisasi.php?id_balita=<?= $id_balita ?>" data-toggle="tab" aria-expanded="false" class="nav-link active">
                                                    Imunisasi
                                                </a>
                                            </li>
                                        </ul>
