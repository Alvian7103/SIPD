                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <div class="card-box">
                                        <ul class="nav nav-pills navtab-bg nav-justified">
                                            ...
                                            <li class="nav-item">
                                                <a href="detail_grafik_bidan.php?id_balita=<?= $id_balita ?>" data-toggle="tab" aria-expanded="false" class="nav-link ">
                                                    Grafik
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a href="detail_imunisasi_bidan.php?id_balita=<?= $id_balita ?>" data-toggle="tab" aria-expanded="false" class="nav-link active">
                                                    Imunisasi
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="tab-content">
                                        <div class="table-responsive">
                                            <table class="table table-bordered toggle-circle" data-paging="true" data-page-size="7">
                                                ...
                                                <?php
                                                $query = "SELECT imunisasi.tgl_imunisasi, balita.nama_balita, balita.tgl_lahir_balita, jenis_imunisasi.nama_imunisasi, imunisasi.ket_imunisasi, pengguna.nama_pengguna
                              FROM imunisasi 
                              LEFT JOIN jenis_imunisasi ON imunisasi.kd_imunisasi = jenis_imunisasi.kd_imunisasi JOIN pengguna ON imunisasi.id_pengguna = pengguna.id_pengguna JOIN balita ON imunisasi.id_balita = balita.id_balita
                              WHERE imunisasi.id_balita = '$id_balita' 
                              ORDER BY tgl_imunisasi DESC";
                                                ...
                                                ?>
                                                        <tbody>
                                                            <tr>
                                                                <td><?php echo $data['tgl_imunisasi'] == "0000-00-00" ? "-" : tgl_indo($data['tgl_imunisasi']); ?></td>
