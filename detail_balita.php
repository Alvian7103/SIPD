                                        ...
                                        <div class="card-box">
                                            <ul class="nav nav-pills navtab-bg nav-justified">
                                                <li class="nav-item" style="padding-bottom:10px;">
                                                    <a href="detail_balita.php?id_balita=<?= $id_balita ?>" data-toggle="tab" aria-expanded="true" class="nav-link active">
                                        ...
                                        <div class="tab-content">
                                            <div class="table-responsive">
                                                <table class="table table-bordered toggle-circle" data-paging="true" data-page-size="7">
                                                    ...
                                                    <?php
                                                    $query = "SELECT penimbangan_pengukuran.tgl_timbang, balita.nama_balita, balita.tgl_lahir_balita, pengguna.nama_pengguna, penimbangan_pengukuran.BB, penimbangan_pengukuran.TB
