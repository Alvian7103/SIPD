...
<body>
    ...
    <br>
    <div class="subjudul">Laporan Data Kehadiran</div>
    ...
    <table width="100%">
        ...
        <?php
        include 'koneksi.php';
        $query = "SELECT * FROM penimbangan_pengukuran LEFT JOIN pengguna ON penimbangan_pengukuran.id_pengguna = pengguna.id_pengguna JOIN balita ON penimbangan_pengukuran.id_balita = balita.id_balita JOIN ibu ON balita.NIK_ibu = ibu.NIK_ibu  WHERE (penimbangan_pengukuran.tgl_timbang  BETWEEN '$tgl_awal' AND '$tgl_akhir' 
