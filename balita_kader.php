                    ...
                    <div class="card-body">
                      ...
                      <form method="post" action="">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-5">
                            <a href="ubah_balita_kader.php" type="button" class="btn btn-danger w-100">Batal</a>
                          </div>
                        </div>
                      </form>
                    </div>
                  ...
                  <table class="table table-bordered table-striped text-center" width="100%" display="block">
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="ubah_balita_kader.php?id_balita=<?= $data['id_balita'] ?>" type="button" class="btn btn-warning"><i class="fas fa-pencil-alt"></i> Ubah</a>
                        </td>
                        </td>
