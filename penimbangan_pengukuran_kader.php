                      ...
                      <form method="post">
                        <div class="modal-body ">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-5">
                              <a href="penimbangan_pengukuran_kader.php" type="button" class="btn btn-danger w-100">Batal</a>
                            </div>
                          </div>
                        </div>
                      </form>
                        ...
                        ORDER BY penimbangan_pengukuran.no_timbang DESC";
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                <a href="ubah_penimbangan_pengukuran_kader.php?no_timbang=<?= $data['no_timbang'] ?>" type="button" class="btn btn-warning" data-toggle="modal"><i class="fas fa-pencil-alt"></i> Ubah</a>
...
if (isset($_POST['simpantimbang'])) {
  ...
  if ($cek > 0) {
    ...
    echo "<script>window.location.href='penimbangan_pengukuran_kader.php'</script>";
  } else {
