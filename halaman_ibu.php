...
if (!isset($_SESSION['NIK_ibu'])) {
    header("location:login_ibu.php?pesan=belum_login");
}
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-user-gear"></i></a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="text-center">
                    <h1 class="display-4">Hello, <b> <?= $_SESSION['nama_ibu'] ?></b></h1>
                    <h2 class="lead"> Selamat Datang di Halaman Pemantauan Tumbuh Kembang Balita Sistem Informasi Pencatatan Data Balita
                    </h2>
                    <hr class="my-4">
                </div>

                <div class="container-fluid px-6">
                    <h1 class="mt-4">SISTEM INFORMASI PENCATATAN DATA BALITA POSYANDU ANGGREK 1</h1>
                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="detail_balita.php?id_balita=<?= $data['id_balita'] ?>" class="btn btn-primary"><i class="fa-solid fa-eye"></i> Lihat</a> </td>
                                </tr>
                            <?php endwhile; ?>
                        </table>
                    </div>
