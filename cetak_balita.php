...
<body>
    ...
    <br>
    <div class="subjudul">Laporan Data Balita</div>
    ...
    <table width="100%">
        ...
        <?php
        $query = "SELECT * FROM balita LEFT JOIN ibu ON balita.NIK_ibu = ibu.NIK_ibu  JOIN pengguna ON balita.id_pengguna = pengguna.id_pengguna order by 
                      id_balita Desc  ";
