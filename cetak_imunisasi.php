...
<body>
    ...
    <br>
    <div class="subjudul">Laporan Data Imunisasi</div>
    ...
    <table width="100%">
        <thead height="15px">
            ...
            <tr>
                <th data-hide="phone">Tanggal Imunisasi</th>
                <th data-hide="phone">ID Balita</th>
                <th data-hide="phone">Balita</th>
                <th data-hide="phone">Usia</th>
                <th data-hide="phone">Jenis Imunisasi</th>
                <th data-hide="phone">Keterangan</th>
                <th data-hide="phone">Kader/Bidan</th>
            </tr>
        </thead>
        <?php
        $query = "SELECT * FROM imunisasi LEFT JOIN jenis_imunisasi ON imunisasi.kd_imunisasi = jenis_imunisasi.kd_imunisasi JOIN pengguna ON imunisasi.id_pengguna = pengguna.id_pengguna JOIN balita ON imunisasi.id_balita = balita.id_balita WHERE (imunisasi.tgl_imunisasi BETWEEN '$tgl_awal' AND '$tgl_akhir' 
        OR ('$tgl_awal' = '' AND '$tgl_akhir' = '')) 
        ORDER BY imunisasi.no_imunisasi ASC";
