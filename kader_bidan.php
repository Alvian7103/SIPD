                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form method="post">
                        <div class="modal-body">
                          <div class="row">
                            <div class="form-group col-md-2">
                              ...
                              <input type="text" maxlength="16" name="NIK_kader" placeholder="NIK Kader" class="form-control" required>
                            </div>
                            <div class="form-group col-md-5">
                              <label for="nama_kader">Nama Kader</label>
                              <input type="text" name="nama_kader" placeholder="Nama Kader" class="form-control" required>
                            </div>
                          </div>
                          <div class="row">
                            <div class="form-group col-md-2">
                              <label for="tempat_lahir_kader">Tempat Lahir </label>
                              <input type="text" name="tempat_lahir_kader" placeholder="Tempat Lahir " class="form-control" required>
                            </div>
                            <div class="form-group col-md-2">
                              <label for="tgl_lahir_kader">Tanggal Lahir </label>
                              <input type="Date" name="tgl_lahir_kader" placeholder="Tanggal Lahir" class="form-control" required>
                            </div>
                            <div class="form-group col-md-2">
                              <label for="agama_kader">Agama Kader</label>
                              <select name="agama_kader" class="form-control" required>
                                <option value="">Pilih Agama Kader</option>
                          ...
                          <div class="row">
                            <div class="form-group col-md-2">
                              <label for="gol_darah_kader">Gol Darah</label>
                            ...
                            <div class="form-group col-md-2">
                              ...
                              <input type="text" name="pekerjaan_kader" placeholder="Pekerjaan" class="form-control" required>
                            </div>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="alamat_kader">Alamat</label>
                            <textarea class="form-control" name="alamat_kader" rows="3" required></textarea>
                          </div>
                          <div class="row">
                            <div class="form-group col-md-2">
                              <label for="no_telp_kader">No Telepon</label>
                              <input type="number" name="no_telp_kader" placeholder="No Telepon" class="form-control" required>
                            </div>
                            <div class="form-group col-md-3">
                              <label for="id_pengguna">ID Pengguna (*Pilih Sesuai Nama Pengguna)</label>
                              <select name="id_pengguna" class="form-control" required>
                                <option hidden>Pilih ID Pengguna</option>
                                <?php
                                include "koneksi.php";
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            <button type="submit" class="btn btn-primary w-100" name="simpan_kader">Simpan</button>
                          </div>
