    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="modal-title" id="staticBackdropLabel">Tambah Data Pemeriksaan</h4>
                                            <form method="post">
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <input type="Date" max="<?php echo date('Y-m-d'); ?>" name="tgl_periksa" placeholder="Tanggal Periksa" class="form-control" required>
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label for="vitA">Pemberian Vitamin A</label>
                                                            <select name="vitA" class="form-control" required>
                                                                <option hidden="">Pilih Vitamin A </option>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <select name="obat_cacing" class="form-control" required>
                                                                <option hidden="">Diberikan Obat Cacing ? </option>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <select name="pemeriksaan_lanjutan" class="form-control" required>
                                                                <option hidden="">Pemeriksaan Lebih Lanjut ?</option>
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <textarea class="form-control" name="hasil" rows="3" required></textarea>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <button type="submit" class="btn btn-primary w-100" name="simpanperiksa">Simpan</button>
                                                        </div>
                                                        <div class="col-md-auto"></div>
                                                        <div class="col-md-5">
                                                            <a href="pemeriksaan_kader.php" type="button" class="btn btn-danger w-100">Batal</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
              ...
              JOIN balita ON pemeriksaan.id_balita = balita.id_balita 
              WHERE pemeriksaan.id_balita LIKE '%$key%' 
              OR balita.nama_balita LIKE '%$key%' 
              ORDER BY pemeriksaan.no_periksa DESC";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="ubah_pemeriksaan_kader.php?no_periksa=<?= $data['no_periksa'] ?>" type="button" class="btn btn-warning" data-toggle="modal"><i class="fas fa-pencil-alt"></i> Ubah</a>
                                                    </td>
                                                    <!-- The Modal Hapus -->
...
if (isset($_POST['simpanperiksa'])) {
    ...
    if ($cek > 0) {
        ...
        echo "<script>window.location.href='pemeriksaan_kader.php'</script>";
    } else {
