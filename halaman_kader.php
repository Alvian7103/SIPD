...
if (!isset($_SESSION['username'])) {
  header("<script>alert('Masukan Username dan Password Anda')</script>")("<script>window.location.href='login.php'</script>");
}
                ...
                <div class="row">
                  <div class="col-xl-6 col-md-6">
                    <div class="card bg-primary text-white mb-4">
                      ...
                      <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="balita_kader.php">Lihat Detail</a>
                  ...
                  <div class="col-xl-6 col-md-6">
                    <div class="card bg-danger text-white mb-4">
                      ...
                      <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="ibu_kader.php">Lihat Detail</a>
                        <div class="small text-white">
                          <i class="fas fa-angle-right"></i>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-xl-4 col-md-4">
                    <div class="card bg-success text-white mb-4">
                      ...
                      <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="penimbangan_pengukuran_kader.php">Lihat Detail</a>
                        <div class="small text-white">
                          <i class="fas fa-angle-right"></i>
                        </div>
                      </div>
                  ...
                  <div class="col-xl-4 col-md-4">
                    <div class="card bg-warning text-white mb-4">
                      ...
                      <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="pemeriksaan_kader.php">lihat Detail</a>
                        <div class="small text-white">
                          <i class="fas fa-angle-right"></i>
                        </div>
                      </div>
                  ...
                  <div class="col-xl-4 col-md-4">
                    <div class="card bg-secondary text-white mb-4">
                      ...
                      <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="imunisasi_kader.php">Lihat Detail</a>
                        <div class="small text-white">
                          <i class="fas fa-angle-right"></i>
                        </div>
                      </div>
