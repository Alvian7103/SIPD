                                        ...
                                        <div class="card-box">
                                            <ul class="nav nav-pills navtab-bg nav-justified">
                                                <li class="nav-item" style="padding-bottom:10px;">
                                                    <a href="detail_balita_bidan.php?id_balita=<?= $id_balita ?>" data-toggle="tab" aria-expanded="true" class="nav-link active">
                                        ...
                                        <div class="tab-content">
                                            <div class="table-responsive">
                                                <table class="table table-bordered toggle-circle" data-paging="true" data-page-size="7">
                                                    ...
                                                    <?php
                                                    $query = "SELECT penimbangan_pengukuran.tgl_timbang, balita.nama_balita, balita.tgl_lahir_balita, pengguna.nama_pengguna, penimbangan_pengukuran.BB, penimbangan_pengukuran.TB FROM penimbangan_pengukuran
                                                    JOIN balita ON penimbangan_pengukuran.id_balita = balita.id_balita
                                                     JOIN pengguna ON penimbangan_pengukuran.id_pengguna = pengguna.id_pengguna
                                                    WHERE penimbangan_pengukuran.id_balita = '$id_balita' 
                                                     ORDER BY penimbangan_pengukuran.tgl_timbang DESC";
                                                    ...
                                                    ?>
                                                            <tbody>
                                                                <tr>
                                                                    <td><?php echo $data['tgl_timbang'] == "0000-00-00" ? "-" : tgl_indo($data['tgl_timbang']); ?></td>
                                                                    <td><?= $data['BB'] ?> Kg</td>
                                                                    <td><?= $data['TB'] ?> Cm</td>
