...
<head>
    ...
    <title>Laporan Data Penimbangan dan Pengukuran</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-6">
                    <h1 class="mt-4">Laporan Data Penimbangan dan Pengukuran</h1>
                    ...
                    <div class="card mt-3">
                        <div class="card-header bg-primary text-light">
                            ...
                            Data Penimbangan dan Pengukuran
                        </div>
                        <div class="card-header">
                            <form method="POST" action="cetak_penimbangan_pengukuran.php">
