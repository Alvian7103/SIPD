            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="modal-title">Tambah Data Jenis Imunisasi</h4>
                      <form method="post">
                        <div class="modal-body">
                          <div class="row">
                            <div class="form-group col-md-3">
                              <label for="nama_imunisasi">Nama Imunisasi</label>
                              <input type="text" name="nama_imunisasi" placeholder="Nama Imunisasi" class="form-control" required>
                            </div>
                            <div class="form-group col-md-6">
                              <label for="ket_jenis_imunisasi">Keterangan</label>
                              <textarea class="form-control" name="ket_jenis_imunisasi" rows="3" required></textarea>
                            </div>
                          </div>
                        </div>
                        <br>
