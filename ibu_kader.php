            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="modal-title">Tambah Data Ibu</h4>
                      <form method="post">
                        <div class="modal-body">
                          ...
                          <div class="row">
                            <div class="form-group col-md-2">
                              ...
                              <input type="text" maxlength="16" name="NIK_ibu" placeholder="NIK Ibu" class="form-control" required>
                            </div>
                          ...
                          <div class="row">
                            <div class="form-group col-md-2">
                              ...
                              <input type="text" name="tempat_lahir_ibu" placeholder="Tempat Lahir " class="form-control" required>
                            </div>
                            <div class="form-group col-md-2">
                              <label for="tgl_lahir_ibu">Tanggal Lahir </label>
                              <input type="Date" max="<?php echo date('Y-m-d'); ?>" name="tgl_lahir_ibu" placeholder="Tanggal Lahir" class="form-control" required>
                            </div>
                            <div class="form-group col-md-2">
                            ...
                            <div class="form-group col-md-2">
                              ...
                              <select name="gol_darah_ibu" class="form-control" required>
                                <option hidden="">Pilih Gol Darah</option>
                                <option value="-">-</option>
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-2">
                                ...
                                <input type="number" name="no_telp_ibu" placeholder="No Telepon" class="form-control" required>
                              </div>
                            ...
                            <div class="row">
                              <div class="form-group col-md-3">
                                ...
                                <input type="text" maxlength="16" name="NIK_suami" placeholder="NIK Suami" class="form-control" required>
                              </div>
                              <div class="form-group col-md-5">
                                <label for="nama_suami">Nama Suami</label>
                                <input type="text" name="nama_suami" placeholder="Nama Suami" class="form-control" required>
                              </div>
                            </div>
                          </div>
                          <br>
                          <div class="row">
                            <div class="col-md-5">
                              <button type="submit" class="btn btn-primary w-100" name="simpan_ibu">Simpan</button>
                            </div>
                            <div class="col-md-auto"></div>
                            <div class="col-md-5">
                              <a href="ibu_kader.php" type="button" class="btn btn-danger w-100">Batal</a>
                            </div>
                          </div>
                      </form>
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $data['password'] ?></td>
                          <td>
                            <a href="ubah_ibu_kader.php?NIK_ibu=<?= $data['NIK_ibu'] ?>" type="button" class="btn btn-warning" data-toggle="modal"><i class="fas fa-pencil-alt"></i> Ubah</a>
...
if (isset($_POST['simpan'])) {
  ...
  if ($cek > 0) {
    ...
    echo "<script>window.location.href='ibu_kader.php'</script>";
  } else {
    $query = "INSERT INTO ibu (NIK_ibu, nama_ibu, tempat_lahir_ibu, tgl_lahir_ibu, agama_ibu, gol_darah_ibu, pendidikan_ibu, pekerjaan_ibu, alamat_ibu, no_telp_ibu, NIK_suami, nama_suami, id_pengguna, password) VALUES('$NIK_ibu','$nama_ibu','$tempat_lahir_ibu','$tgl_lahir_ibu','$agama_ibu','$gol_darah_ibu','$pendidikan_ibu','$pekerjaan_ibu','$alamat_ibu','$no_telp_ibu','$NIK_suami','$nama_suami','$id_pengguna','$password')";
