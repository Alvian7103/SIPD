            ...
            <main>
                <div class="container-fluid px-6">
                    ...
                    <div class="card mt-3">
                        ...
                        $query = "SELECT * FROM pengguna WHERE pengguna.id_pengguna = '$id_pengguna'";
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="modal-title">Ubah Data <?= $data['nama_pengguna'] ?></h4>
                                                <form method="post">
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div hidden="form-group">
                                                                <label for="id_pengguna">ID Pengguna</label><br>
                                                                <input type="number" name="id_pengguna" class="col-md-1" value="<?= $data['id_pengguna'] ?>" placeholder="ID Pengguna" class="form-control" readonly>
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                <label for="nama_pengguna">Nama Pengguna</label>
                                                                <input type="text" name="nama_pengguna" value="<?= $data['nama_pengguna'] ?>" placeholder="Nama Pengguna" class="form-control" required>
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                <label for="username">Username</label>
                                                                <input type="text" name="username" value="<?= $data['username'] ?>" placeholder="Username" class="form-control" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-md-4">
                                                            ...
                                                            <div class="form-group col-md-2">
                                                                ...
                                                                <select name="level" class="form-control" required>
                                                                    <option hidden="<?= $data['level'] ?>"><?= $data['level'] ?></option>
                                                                    <option value="Bidan/Petugas">Bidan</option>
