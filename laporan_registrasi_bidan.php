        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-6">
                    <h1 class="mt-4">Laporan Data Kehadiran</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Data Kehadiran Posyandu Anggrek 1 Desa Tambak</li>
                    </ol>
                    <div class="card mt-3">
                        ...
                        <div class="card-header">
                            <form method="POST" action="cetak_registrasi.php">
                        ...
                        JOIN balita ON penimbangan_pengukuran.id_balita = balita.id_balita JOIN ibu ON balita.NIK_ibu = ibu.NIK_ibu
                        ...
                        ORDER BY penimbangan_pengukuran.no_timbang DESC";
                                                ...
                                                $tgl_awal = $_POST['tgl_awal'];
                                                $tgl_akhir = $_POST['tgl_akhir'];
                                                $query = "SELECT * FROM penimbangan_pengukuran LEFT JOIN pengguna ON penimbangan_pengukuran.id_pengguna = pengguna.id_pengguna JOIN balita ON penimbangan_pengukuran.id_balita = balita.id_balita JOIN ibu ON balita.NIK_ibu = ibu.NIK_ibu  WHERE tgl_timbang BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "' order by no_timbang ASC";
                                            } else {
                                                $query = "SELECT * FROM penimbangan_pengukuran LEFT JOIN pengguna ON penimbangan_pengukuran.id_pengguna = pengguna.id_pengguna JOIN balita ON penimbangan_pengukuran.id_balita = balita.id_balita JOIN ibu ON balita.NIK_ibu = ibu.NIK_ibu  order by no_timbang desc";
                                            }
