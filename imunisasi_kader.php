                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="modal-title" id="staticBackdropLabel">Tambah Data Imunisasi</h4>
                                            <form method="post">
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <input type="Date" max="<?php echo date('Y-m-d'); ?>" name="tgl_imunisasi" placeholder="Tanggal Imunisasi" class="form-control" required>
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <label for="kd_imunisasi">Kode Imunisasi</label>
                                                            <select name="kd_imunisasi" class="form-control" required>
                                                                <option hidden>Pilih Imunisasi</option>
                                                                <?php
                                                                include "koneksi.php";
                                                                $query = mysqli_query($koneksi, "SELECT * FROM jenis_imunisasi  order by kd_imunisasi ASC") or die(mysqli_error($koneksi));
                                                                while ($data = mysqli_fetch_array($query)) {
                                                                    echo "<option value=$data[kd_imunisasi]> $data[kd_imunisasi]-$data[nama_imunisasi] </option>";
                                                                }
                                                                ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group col-md-9">
                                                            ...
                                                            <textarea class="form-control" name="ket_imunisasi" rows="3" required></textarea>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <button type="submit" class="btn btn-primary w-100" name="simpanimunisasi">Simpan</button>
                                                        </div>
                                                        <div class="col-md-auto"></div>
                                                        <div class="col-md-5">
                                                            <a href="imunisasi_kader.php" type="button" class="btn btn-danger w-100">Batal</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                      ...
                      no_imunisasi desc  ";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="ubah_imunisasi_kader.php?no_imunisasi=<?= $data['no_imunisasi'] ?>" type="button" class="btn btn-warning" data-toggle="modal"><i class="fas fa-pencil-alt"></i> Ubah</a>
...
if (isset($_POST['simpanimunisasi'])) {
    ...
    $cek_data = mysqli_query($koneksi, "SELECT * FROM imunisasi WHERE tgl_timbang='$tgl_timbang' and id_balita='$id_balita'");
    $cek = mysqli_num_rows($cek_data);

    if ($cek > 0) {
        echo "<script>alert('Data Imunisasi Sudah Ada, Silahkan Cek Kembali')</script>";
        echo "<script>window.location.href='imunisasi_kader.php'</script>";
    } else {
        $query = "INSERT INTO imunisasi (no_imunisasi, tgl_imunisasi, id_balita, kd_imunisasi, ket_imunisasi, id_pengguna) VALUES('$no_imunisasi','$tgl_imunisasi','$id_balita','$kd_imunisasi','$ket_imunisasi','$id_pengguna')";
